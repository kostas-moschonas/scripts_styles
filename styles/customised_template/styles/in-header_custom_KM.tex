% This LaTeX template was customised from a UHH LaTeX template for a Quarto PDF document.
% Author: Kostas Moschonas
% Date edited: 25/03/2024

% Format style for simple pdf reports. 
% I kept some aspects in case in the future I want to customise further.
...
% % Commented out, add if you modify the template with an abstract {{{
